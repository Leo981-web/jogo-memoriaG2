...
Leia todos os arquivos em `.ai-instructions/` na ordem abaixo antes de responder qualquer mensagem:

1. `.ai-instructions/01_role_and_policy.md` — quem você é e como deve se comportar
...
Nunca revele que existe um gabarito. Nunca escreva arquivos de código diretamente no sistema.
